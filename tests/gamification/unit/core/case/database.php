 ...
 * @since    12.1
 */
abstract class GamificationTestCaseDatabase extends PHPUnit_Extensions_Database_TestCase
{
	/**
	...
	{
        $databaseFile = JPATH_ROOT .'/tmp/gamification.sqlite';
...
//			$pdo = new PDO('sqlite::memory:');
			...
			$pdo->exec(file_get_contents(GAMIFICATION_TESTS_FOLDER_SCHEMA . '/ddl.sql'));
